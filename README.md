...
The app is designed to run on your machine with a local SQLite database. Source credentials, tasks, reminders, generated briefs, and planning records stay local unless you explicitly connect external services such as Google Calendar, Telegram, OpenAI-compatible model providers, X, Reddit, or podcast transcription services.
